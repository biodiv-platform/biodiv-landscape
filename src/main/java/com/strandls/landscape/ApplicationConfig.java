...
@OpenAPIDefinition(info = @Info(title = "Landscape Module MicroServices", version = "1.0.0", description = "Landscape Module MicroServices"), servers = {
		@Server(url = "http://localhost:8080/landscape-api/api/") })
